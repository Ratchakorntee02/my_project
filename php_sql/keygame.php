...
<div class="container mt-4">
    ...
    <div id="carouselExample" class="carousel slide banner" data-bs-ride="carousel">
      ...
      <div class="row text-center mt-4">
        <h3 class="game-title mb-4">KEYS GAME</h3>

        <div class="col-3 game-card"><img src="wukong.jpg" alt="Wukong">
          <p>wukong</p>
        </div>

        <div class="col-3 game-card"><img src="mhw.jpg" alt="Monter Hunter Wilds">
          <p>Monter Hunter Wilds</p>
        </div>

        <div class="col-3 game-card"><img src="sekiro.jpg" alt="Sekiro">
          <p>Sekiro</p>
        </div>

        <div class="col-3 game-card"><img src="elden.jpg" alt="Elden Ring">
          <p>Elden Ring</p>
        </div>
    </div>
</div>
